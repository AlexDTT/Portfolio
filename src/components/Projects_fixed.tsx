...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Cheeath",
      description: "Modern web application built with advanced frontend technologies.",
      tags: ["Symfony", "PHP", "MySQL", "JavaScript", "HTML/CSS", "Twig"],
      github: "#",
      demo: "#",
    },
    {
      title: "Project Two",
      description: "An AI-powered tool that analyzes data patterns and provides insightful visualizations for better decision making.",
    ...
    {
      title: "Project Three",
      description: "Mobile-responsive e-commerce platform with real-time inventory management and payment integration.",
    ...
    {
      title: "Project Four",
      description: "Open-source library that simplifies complex algorithms implementation for educational purposes.",
      tags: ["C++", "Algorithms", "Documentation"],
      github: "#",
      demo: "#",
    },
  ];
